document.addEventListener("DOMContentLoaded", function () {
  ...
  function loadFormData() {
    ...
    if (savedData) {
      ...
      document.getElementById("addressInPadang").value =
        formData.addressInPadang || "";
      ...
      document.getElementById("reasonToJoin").value =
  ...
  // Handle form submission
    form.addEventListener("submit", function (e) {
      ...
      const softwareChecked = document.querySelectorAll(
      ...
      if (otherSoftwareCheckbox.checked) {
        formData.append(
          "otherSoftwareText",
          document.getElementById("otherSoftwareText").value
        );
      }
      ...
      formData.append(
        "sendCopy",
        document.getElementById("sendCopy").checked ? "on" : "off"
      );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (currentDate > registrationEndDate) {
    ...
    closedMessage.innerHTML =
      "<h4>Pendaftaran Ditutup</h4><p>Maaf, periode pendaftaran telah berakhir.</p>";

    document
      .querySelector(".container")
      .insertBefore(closedMessage, document.getElementById("recruitmentForm"));
  }
});
